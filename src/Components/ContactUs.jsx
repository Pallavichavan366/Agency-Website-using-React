...
const ContactUs = () => {
  ...
  return (
    ...
    lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        <Title title='Reach out to us' desc='Let’s collaborate! Reach out to our team for quick support 
        ...
        <div>
            ...
            <div className='flex pl-3 rounded-lg border border-gray-300
             dark:border-gray-600'>
                ...
                <input name="name" type="text" placeholder='Enter your name ' className='w-full p-3 
     ...
     <div>
            ...
            <div className='flex pl-3 rounded-lg border border-gray-300
             dark:border-gray-600'>
                ...
                <input name="email" type="text" placeholder='Enter your email ' className='w-full p-3 
                 text-sm outline-none ' required/>
            </div>
        </div>
